  ...
  return (
    <DashboardShell>
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_240px]">
        <div>
          {project.imageSrc && (
            <div className="relative mb-8 aspect-[16/9] overflow-hidden rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-bg-warm)]">
              <Image
          ...
          {project.gallery && project.gallery.length > 0 && (
            <div className="mb-8 grid grid-cols-3 gap-2">
              {project.gallery.map((src, idx) => (
                <div
                  key={src}
                  className="relative aspect-[4/3] overflow-hidden rounded-xl border border-[var(--color-border-soft)] bg-[var(--color-bg-warm)]"
                >
                  <Image
                    src={src}
