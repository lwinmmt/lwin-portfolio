...
export const projects: Project[] = [
  {
    ...
    descriptionVi:
      "Pipeline chạy trên Azure cho hệ thống giám sát nước thải COVID-19 của NEA. Hơn 100 RTU công nghiệp Tastek với khe SIM, truyền dữ liệu trực tiếp qua mạng di động về một Azure VM duy nhất chạy Mosquitto, database và dashboard. Cảnh báo Twilio WhatsApp gửi tới kỹ sư trực. Góp phần vào giải Lee Hsien Loong IDM Smart Nation Award 2022. Được Straits Times đưa tin.",
