...
export const messages = {
  en: {
    ...
    "resume.highlight.w2":
      "NEA wastewater monitoring. Contributed to LHL IDM Smart Nation Award 2022.",
  ...
  vi: {
    ...
    "resume.highlight.w2":
      "Giám sát nước thải NEA. Đóng góp cho Giải thưởng Smart Nation LHL IDM 2022.",
    "resume.highlight.sp-iot":
