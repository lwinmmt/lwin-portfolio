...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Cmd+K palette opener. Also discoverable via the global keyboard
          shortcut, but the button makes it findable on first visit. */}
      <button
        type="button"
        onClick={() =>
          window.dispatchEvent(new Event("cmdpalette:open"))
        }
