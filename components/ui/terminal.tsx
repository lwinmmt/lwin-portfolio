        ...
        >
          ...
          {(phase === "done" ||
            ...
            <div className="leading-relaxed whitespace-pre-wrap">
              {prompt}
              <span
                className={`inline-block h-4 w-2 bg-neutral-300 align-middle transition-opacity duration-100 ${
